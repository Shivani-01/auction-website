...
public class bregister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String query="insert into buylogin values("+'"'+a+'"'+','+'"'+b+'"'+");";
        ...
        try {
	        ...
	        RequestDispatcher rd1=request.getRequestDispatcher("/logbuy.html");  
	        ...
	        catch(Exception e)
	        {
	        	...
	        	out.println("</script>");
		         RequestDispatcher rd=request.getRequestDispatcher("/registerb.html");  
